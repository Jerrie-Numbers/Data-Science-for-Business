# -*- coding: utf-8 -*-
"""Copy of Sales Department skeleton

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QdC2sCKQumwnzL8qrc-iLgxecM_ZtY3P
...
sales_train_df = pd.read_csv('/content/drive/My Drive/Data Science for Business/train.csv')
...
store_info_df = pd.read_csv('/content/drive/My Drive/Data Science for Business/store.csv')
